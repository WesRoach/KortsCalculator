...
class CraftWindow(QDialog, Ui_B_CraftWindow):
    ...
    def loadgems(self, gems):
        ...
        for slot in range(0, 4):
            ...
            while slot < len(gems) and (gems[slot].type() == 'Unused' or gems[slot].slotType() != 'player'):
                del gems[slot]
    ...
    def computeMaterials(self):
        ...
        for matctl, matlist in ((self.MatsUsed, materials['Used']), (self.MatsExpected, materials['Expected'],)):
            matctl.clear()
